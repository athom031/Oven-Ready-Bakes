  ...
  return (
    <div>
      <blockquote
        ...
        data-instgrm-permalink="https://www.instagram.com/ovenreadybakes/?utm_source=ig_embed&amp;utm_campaign=loading"
        ...
        <div style={{ padding: '16px' }}>
          ...
          >
            ...
            <div style={{ width: '50px', height: '50px' }}>
              <svg width="50" height="50" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            ...
            <div style={{ display: 'flex', flexDirection: 'row', marginBottom: '14px', alignItems: 'center' }}>
              ...
              <div style={{ marginLeft: 'auto' }}>
                ...
                <div style={{ width: '0', borderTop: '8px solid #F4F4F4', borderLeft: '8px solid transparent', transform: 'translateY(-4px) translateX(8px)' }}></div>
              </div>
            </div>
